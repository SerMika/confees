<div class="container main">
    ...
    if (!$row) { ?>
        <div class="row d-flex justify-content-center">
            <div class="col-12 d-flex justify-content-center text-center">
                <h2>По вашему запросу не было найдено ни одной конференции</h2>
            </div>
            <div class="col-12 d-flex justify-content-center text-center">
                <p>Попробуйте задать другой параметр запроса либо посмотрите все существующие конференции.</p>
            </div>
        </div>
    <?php } else { ?>
        <div class="row d-flex justify-content-center">
    ...
    <div class="row d-flex justify-content-center" style="padding-top: 15px;">
        <button type="button" onClick="location.href='list';" class="btn btn-success" style="font-weight: bold; font-size: 1.3rem;">
            На главную
        </button>
    </div>
    <!-- Модальное окно -->
